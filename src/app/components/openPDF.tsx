...
export default function OpenPDF (){
  ...
  const handleOpenPDF = () => {
    window.open("/MDO_Planilha_Estorno_Entrada.pdf", "_blank"); 
  };

  return (
    <button
      onClick={handleOpenPDF}
      className="mt-4 p-2 bg-blue-400 text-white rounded-full w-auto h-auto cursor-pointer hover:shadow-lg hover:bg-blue-900"
    >
