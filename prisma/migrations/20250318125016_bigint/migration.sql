/*
  ...
  - You are about to alter the column `codigoProduto` on the `Item` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `valor` on the `Item` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `valor` on the `NotaFiscal` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `aliquota` on the `ResumoFiscal` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `baseCalculo` on the `ResumoFiscal` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `icmsDestacado` on the `ResumoFiscal` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
...
CREATE TABLE "new_ResumoFiscal" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "notaFiscalId" INTEGER NOT NULL,
    "baseCalculo" BIGINT NOT NULL,
    "aliquota" BIGINT NOT NULL,
    "icmsDestacado" BIGINT NOT NULL,
